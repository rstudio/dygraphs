...
You can specify an alternate color palette for series lines using the `colors` option. For example, to choose a palette from [RColorBrewer](http://cran.rstudio.com/web/packages/RColorBrewer/index.html):
