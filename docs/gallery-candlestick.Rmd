...
You can also use `compress` function argument to compress chart data annually,
quarterly, monthly, weekly or daily depending on the current chart zoom level to
prevent chart bars overflow:
