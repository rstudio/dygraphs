...
Here we override both of these defaults ensureing that the legend is always visible and that point values are still displayed even after the mouse leaves the plot:
