...
In this example we specify a larger circle size for point highlighting as well as more decicively fade the non-highlighted series. We also request that the highlighting persist even after the mouse leaves the graph area.
